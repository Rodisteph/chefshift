...
const C = {
  nl: {
    ...
    s2p: [
      ...
      ['3. Bevestig de uren en betaal.', ' Na de shift geef je de gewerkte eindtijd door. Je betaalt veilig via iDEAL en alles staat vastgelegd voor je administratie, inclusief 9% btw.'],
    ],
  ...
  en: {
    ...
    s2p: [
      ...
      ['3. Confirm the hours and pay.', ' After the shift you confirm the worked end time. You pay safely via iDEAL and everything is recorded for your administration, including 9% VAT.'],
    ],
    ...
    faq: [
      ...
      ['How does administration and invoicing work?', 'All agreements, hours and payments run through the platform. After each shift you find an overview with worked hours and amount including 9% VAT in your dashboard. That saves hours of admin.'],
    ],
