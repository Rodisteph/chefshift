...
const C = {
  nl: {
    ...
    s2p: [
      ...
      ['3. Bevestig de uren en betaal.', ' Na de shift geef je de gewerkte eindtijd door. Je betaalt veilig via iDEAL en ontvangt direct een factuur met nummer en 9% btw-specificatie, klaar voor je administratie.'],
    ],
  ...
  en: {
    ...
    s2p: [
      ...
      ['3. Confirm the hours and pay.', ' After the shift you confirm the worked end time. You pay safely via iDEAL and instantly receive an invoice with a number and 9% VAT breakdown, ready for your administration.'],
    ],
    ...
    faq: [
      ...
      ['How does administration and invoicing work?', 'All agreements, hours and payments run through the platform. After every paid shift the invoice is automatically ready on your invoices page: with an invoice number, worked hours and a 9% VAT breakdown. You download it as a PDF for your bookkeeping. That saves hours of admin.'],
    ],
