...
const artikelen: Record<'nl' | 'en', { titre: string; tekst: string }[]> = {
  ...
  en: [
    ...
    { titre: 'Article 5. Rates and commission', tekst: 'The hourly rate is agreed per shift between Client and Freelancer. ChefShift charges an intermediation commission of 15% (VAT included) on the invoice value. The commission is shown transparently during payment via the Platform. Changes to the commission rate are announced by email at least 30 days in advance; for shifts already confirmed, the rate at the moment of confirmation applies.' },
...
const titres = {
  nl: { h1: 'Algemene voorwaarden', sub: 'ChefShift, platform voor freelance keukenpersoneel. Versie 1.3, 29 juli 2026.', disclaimer: 'Conceptversie: laat deze voorwaarden valideren door een jurist voordat je ze definitief publiceert.' },
  en: { h1: 'Terms & Conditions', sub: 'ChefShift, the marketplace for freelance kitchen staff. Version 1.3, July 29, 2026.', disclaimer: 'Draft version: have these terms validated by a lawyer before publishing them definitively.' }
}
