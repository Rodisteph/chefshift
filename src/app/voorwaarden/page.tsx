...
const artikelen: Record<'nl' | 'en', { titre: string; tekst: string }[]> = {
  nl: [
    ...
    { titre: 'Artikel 5. Tarieven en commissie', tekst: 'Het uurtarief wordt per shift afgesproken tussen Opdrachtgever en Zelfstandige. Over de factuurwaarde brengt ChefShift een bemiddelingscommissie van 15% in rekening. ChefShift is vrijgesteld van btw op grond van de kleineondernemersregeling (KOR); over de commissie wordt daarom geen btw gerekend. De commissie wordt zichtbaar verrekend bij de betaling via het Platform. Wijzigingen in het commissiepercentage kondigen wij minimaal 30 dagen vooraf aan per e-mail; voor reeds bevestigde shifts geldt het percentage op het moment van bevestiging.' },
    { titre: 'Artikel 6. Betaling en facturatie', tekst: 'Betaling verloopt via het Platform (o.a. iDEAL en creditcard via Stripe). Betaling is pas mogelijk nadat de shift is voltooid. De Zelfstandige machtigt ChefShift om namens en voor rekening van de Zelfstandige een factuur uit te reiken aan de Opdrachtgever (zelf-facturatie). Deze factuur vermeldt de naam, het KvK-nummer en het btw-nummer van de Zelfstandige. De Zelfstandige blijft zelf verantwoordelijk voor zijn fiscale verplichtingen en kan bezwaar maken tegen een uitgereikte factuur via info@chefshift.nl. Na betaling wordt het afgesproken bedrag, verminderd met de commissie, uitbetaald aan de Zelfstandige. ChefShift beheert geen gelden namens derden buiten de betaalstromen van de betaaldienstverlener.' },
  ...
  en: [
    ...
    { titre: 'Article 5. Rates and commission', tekst: 'The hourly rate is agreed per shift between Client and Freelancer. ChefShift charges an intermediation commission of 15% on the invoice value. ChefShift is exempt from VAT under the Dutch small businesses scheme (KOR); no VAT is charged on the commission. The commission is shown transparently during payment via the Platform. Changes to the commission rate are announced by email at least 30 days in advance; for shifts already confirmed, the rate at the moment of confirmation applies.' },
    { titre: 'Article 6. Payment and invoicing', tekst: 'Payments are processed via the Platform (including iDEAL and credit card via Stripe). Payment is only possible after the shift has been completed. The Freelancer authorises ChefShift to issue invoices to the Client in the name and on behalf of the Freelancer (self-billing). Each invoice states the Freelancer\u2019s name, KvK number and VAT number. The Freelancer remains responsible for their own tax obligations and may object to an issued invoice via info@chefshift.nl. After payment, the agreed amount minus the commission is paid out to the Freelancer. ChefShift does not hold funds on behalf of third parties outside the payment flows of the payment service provider.' },
...
const titres = {
  nl: { h1: 'Algemene voorwaarden', sub: 'ChefShift, platform voor freelance keukenpersoneel. Versie 1.4, 29 juli 2026.', disclaimer: 'Conceptversie: laat deze voorwaarden valideren door een jurist voordat je ze definitief publiceert.' },
  en: { h1: 'Terms & Conditions', sub: 'ChefShift, the marketplace for freelance kitchen staff. Version 1.4, July 29, 2026.', disclaimer: 'Draft version: have these terms validated by a lawyer before publishing them definitively.' }
}
