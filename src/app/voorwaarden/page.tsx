...
const titres = {
  nl: { h1: 'Algemene voorwaarden', sub: 'ChefShift, platform voor freelance keukenpersoneel. Versie 1.2, 29 juli 2026.', disclaimer: 'Conceptversie: laat deze voorwaarden valideren door een jurist voordat je ze definitief publiceert.' },
  en: { h1: 'Terms & Conditions', sub: 'ChefShift, the marketplace for freelance kitchen staff. Version 1.2, July 29, 2026.', disclaimer: 'Draft version: have these terms validated by a lawyer before publishing them definitively.' }
}
