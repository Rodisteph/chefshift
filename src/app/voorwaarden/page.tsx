...
const artikelen: Record<'nl' | 'en', { titre: string; tekst: string }[]> = {
  nl: [
    ...
    { titre: 'Artikel 5. Tarieven en commissie', tekst: 'Het uurtarief wordt per shift afgesproken tussen Opdrachtgever en Zelfstandige. Over de factuurwaarde brengt ChefShift een bemiddelingscommissie van 12% (excl. 21% btw) in rekening. De commissie wordt zichtbaar verrekend bij de betaling via het Platform.' },
  ...
  en: [
    ...
    { titre: 'Article 5. Rates and commission', tekst: 'The hourly rate is agreed per shift between Client and Freelancer. ChefShift charges an intermediation commission of 12% (excl. 21% VAT) on the invoice value. The commission is shown transparently during payment via the Platform.' },
...
const titres = {
  nl: { h1: 'Algemene voorwaarden', sub: 'ChefShift, platform voor freelance keukenpersoneel. Versie 1.0, juli 2026.', disclaimer: 'Conceptversie: laat deze voorwaarden valideren door een jurist voordat je ze definitief publiceert.' },
  en: { h1: 'Terms & Conditions', sub: 'ChefShift, the marketplace for freelance kitchen staff. Version 1.0, July 2026.', disclaimer: 'Draft version: have these terms validated by a lawyer before publishing them definitively.' }
}
