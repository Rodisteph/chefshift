  ...
  return (
    <main style={{ fontFamily: FONT, background: '#f6f7f2', color: '#23281f', minHeight: '100vh' }}>
      ...
      <div className="cs-wrap" style={{ maxWidth: 640, margin: '0 auto', padding: '44px 24px 60px' }}>
        ...
        <p className="cs-fade cs-d1" style={{ color: '#6b7268', fontSize: 14.5, marginTop: 0, marginBottom: 28 }}>
          {t('set_sub')}
        </p>
        ...
        {/* ===== Langue ===== */}
        <section className="cs-fade cs-d2" style={{ ...carte, marginBottom: 20, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 14 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <IcoTile n="msg" s={16} taille={36} />
            <div>
              <h2 style={titreBloc}>{t('set_lang_title')}</h2>
              <p style={{ color: '#6b7268', fontSize: 13, margin: '3px 0 0' }}>{t('set_lang_desc')}</p>
            </div>
          </div>
          <div style={{ display: 'flex', gap: 8 }}>
            <button
              ...
              style={{
                ...
                color: '#23281f', borderRadius: 999, padding: '9px 22px',
        ...
        {/* ===== Compte ===== */}
        <section className="cs-fade cs-d2" style={{ ...carte, marginBottom: 20 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <IcoTile n="user" s={16} taille={36} />
            <div>
              <h2 style={titreBloc}>{t('set_account_title')}</h2>
              <p style={{ color: '#6b7268', fontSize: 13, margin: '3px 0 0' }}>
            ...
            {estKok && (
              <a
                ...
                style={{
                  ...
                  padding: '10px 20px', fontWeight: 700, fontSize: 13.5, color: '#23281f',
        ...
        {/* ===== Aide / contact ===== */}
        <section className="cs-fade cs-d3" style={{ ...carte, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 14 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <IcoTile n="msg" s={16} taille={36} />
            <div>
              <h2 style={titreBloc}>{t('set_contact_title')}</h2>
              <p style={{ color: '#6b7268', fontSize: 13, margin: '3px 0 0' }}>{t('contact_sub')}</p>
            </div>
          </div>
          <a
