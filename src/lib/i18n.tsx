...
const dict = {
  nl: {
    ...
    testi1_q: 'Binnen een uur had ik een ervaren kok voor een uitgevallen dienst. ChefShift heeft mijn avond gered.',
    testi1_a: 'Sanne',
    testi1_r: 'Restauranteigenaar',
    testi2_q: 'Ik kies zelf mijn shifts en word snel en correct betaald. Eindelijk een platform dat écht werkt.',
    testi2_a: 'Mark',
    testi2_r: 'Zelfstandig kok',
    testi3_q: 'Overzichtelijk, betrouwbaar en geen gedoe met facturen. We gebruiken het elke week.',
    testi3_a: 'Lisa',
    testi3_r: 'Horecamanager',
    rev_over: 'Ervaringen',
    rev_title: 'Wat gebruikers zeggen',
    rev_sub: 'Echte beoordelingen van koks en horecazaken op het platform.',
  ...
  en: {
    ...
    testi1_q: 'Within an hour I had an experienced chef for a no-show. ChefShift saved my evening.',
    testi1_a: 'Sanne',
    testi1_r: 'Restaurant owner',
    testi2_q: 'I pick my own shifts and get paid quickly and correctly. Finally a platform that really works.',
    testi2_a: 'Mark',
    testi2_r: 'Self-employed chef',
    testi3_q: 'Clear, reliable and no hassle with invoices. We use it every week.',
    testi3_a: 'Lisa',
    testi3_r: 'Hospitality manager',
    rev_over: 'Testimonials',
    rev_title: 'What users say',
    rev_sub: 'Real reviews from chefs and hospitality businesses on the platform.',
